      ...
      <form onSubmit={submit} noValidate>
        ...
        <div className="flex gap-4">
          <button
            ...
            className="flex  h-12 flex-1 items-center justify-center rounded-lg border border-secondary bg-white font-bold text-text-default transition hover:bg-neutral-gray disabled:opacity-60 xs:w-full sm:flex-1"
          >
            انصراف
          </button>
          <button
            type="submit"
            disabled={isSubmitting || success}
            className="flex h-12 flex-1 items-center justify-center rounded-lg bg-secondary font-bold text-white transition hover:opacity-90 disabled:opacity-60 xs:w-full sm:flex-1"
          >
            {success
              ? 'ثبت شد'
              : isSubmitting
