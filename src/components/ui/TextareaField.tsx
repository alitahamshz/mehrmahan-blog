    ...
    return (
      <div className={`mb-4 ${wrapperClassName}`}>
        ...
        <textarea
          ...
          className={`w-full resize-none rounded-lg border bg-white px-4 py-3 text-sm text-text-default outline-none placeholder:text-text-secondary/60 focus:ring-2 ${border} ${className}`}
          {...rest}
        />
