...
const BLOGS_ENDPOINT = `${process.env.NEXT_PUBLIC_API_BASE_URL}blog/blogs/`;
const BLOG_CATEGORIES_ENDPOINT = `${process.env.NEXT_PUBLIC_API_BASE_URL}blog/blog-categories/`;
const CREATE_BLOG_ENDPOINT = `${process.env.NEXT_PUBLIC_API_BASE_URL}blog/blog/`;
