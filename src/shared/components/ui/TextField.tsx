      ...
      <div className={`mb-4 ${wrapperClassName}`}>
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`h-10 w-full rounded-lg border bg-white lg:bg-transparent text-sm text-text-default outline-none placeholder:text-text-secondary/60 focus:ring-2 ${
